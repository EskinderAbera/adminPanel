...
const EditDept = () => {
  ...
  useEffect(() => {
    if (DashboardPage === "dept") {
      ...
      setPerspectiveWeight(index !== "" ? kpis[index].perspective_weight : "");
      // setUserId(index !== "" ? kpis[index].user : "");
    } else if (DashboardPage === "obj") {
      setObjective(index !== "" ? kpis[index].objective_name : "");
      setObjectiveWeight(index !== "" ? kpis[index].objective_weight : "");
  ...
  return (
    ...
    <div className="Container">
      ...
      {/* <form onSubmit={handleSubmit(pageType === "ADD"? handleAdd : handleSave)}>  */}
        {DashboardPage === "dept" && (
          <>
        ...
        {DashboardPage === "persp" && (
          <div className="InputFields">
            ...
            <div>
              <span style={{ fontSize: "1.5rem" }}> Perspective Weight: </span>
              <input
                id="HierarchyInput"
                type="text"
        ...
        {pageType === "ADD" && (
          <button className="btn saveadd" onClick={handleAdd}>
            ADD
          </button>
        )}
        {pageType !== "ADD" && (
          <button className="btn saveadd" onClick={handleSave}>
            SAVE
          </button>
        )}
